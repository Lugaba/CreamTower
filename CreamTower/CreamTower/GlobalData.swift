...
public var itemsData: [ItemEntity] = [
    ...
    ItemEntity(name: "Outline", price: 2250, imageName: "outlineBall", isBought: false, isSelected: false, type: objectType.flavor.rawValue),
    ...
    ItemEntity(name: "Dance", price: 4500, imageName: "twisterBall", isBought: false, isSelected: false, type: objectType.flavor.rawValue),
    ItemEntity(name: "Zombie", price: 7000, imageName: "zombieBall", isBought: false, isSelected: false, type: objectType.flavor.rawValue),
    ...
    ItemEntity(name: "Outline", price: 2250, imageName: "outlineCone", isBought: false, isSelected: false, type: objectType.cone.rawValue),
    ...
    ItemEntity(name: "MyLittleCone", price: 8000, imageName: "myLittleCone", isBought: false, isSelected: false, type: objectType.cone.rawValue),
